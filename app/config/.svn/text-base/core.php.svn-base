 ...
 */
	Configure::write('Security.salt', '2ZhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '45859309657453542496749683645');
...
*
	 Cache::config('default', array(
		...
		'probability'=> 100, //[optional]
 		...
 		'prefix' => 'BPOC_cake_', //[optional]  prefix every cache file with this string
 ...
 */ 	 
  ...
  Cache::config('default', array(
 		...
 		'probability'=> 100, //[optional]
  		'prefix' => Inflector::slug(APP_DIR) . '_BPOC_', //[optional]  prefix every cache file with this string
 	));
